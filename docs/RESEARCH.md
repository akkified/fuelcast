...
> High-school athletes train hard, often every day after school, but almost none get guidance on **when** to eat and drink around training. They show up to practice under-fueled and under-hydrated, recover poorly, and the tools available to them (calorie-counting apps) are designed for weight loss, not performance, and can be unhealthy for teens.
...
**Primary: high-school athletes, ages 14–18**, especially those with after-school practice, weekday games, and early-morning sessions or lifts.

| Persona | Situation | What FuelCast gives them |
|---|---|---|
| **Maya, 16, varsity soccer** | Practice at 3:45 on weekdays, matches Wed/Fri, conditioning at 6:30 AM on Tuesdays. Often skips lunch and grabs vending-machine chips. | A timeline that tells her lunch *is* her pre-practice meal, a top-off from what's in her bag, and a "Recover + reload" on her double day. |
| **Jordan, 15, JV basketball** | New to high-school sports, no idea what to eat, embarrassed to ask. | Plain-language "why it matters" for every window; no judgment, no calories. |
